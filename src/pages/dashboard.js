    ...
    return (
        <>
            ...
            <Popover popoverTitle={'Crear tablero'}>
                <h3>Título del tablero<span className="required-field-indicator">*</span></h3>
            ...
            <Popover popoverTitle={'Notificaciones'}>
                <Notification>
                    <span>Alicia te invitó a colaborar en su tablero
                    “jardinería-2854”</span>
                </Notification>
                <Notification>
                    <span>Alessia te invitó a colaborar en su tablero
                    “viajes”</span>
                </Notification>
            </Popover>
